 ...
 * @author jihad
 */
public class PaymentMethod12month extends javax.swing.JFrame {

    /**
     * Creates new form PaymentMethod12month
     */
    public PaymentMethod12month() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 13, -1, -1));

        jLabel4.setFont(new java.awt.Font("Lucida Sans Typewriter", 0, 18)); // NOI18N
        jLabel4.setText("5500");
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 10, 100, 34));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PaymentMethod12month.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PaymentMethod12month().setVisible(true);
            }
        });
    }
