 ...
 * @author User
 */
public class BenchPress extends javax.swing.JFrame {

    /**
     * Creates new form BenchPress
     */
    public BenchPress() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ep/benchpress.png"))); // NOI18N
        ...
        jLabel5.setText("a strength training exercise that targets the chest, ");

        jLabel6.setFont(new java.awt.Font("Lucida Sans", 1, 12)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("shoulders, and triceps by pressing a weighted barbell");

        jLabel7.setFont(new java.awt.Font("Lucida Sans", 1, 12)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("upward from a lying position.");
        ...
        jLabel17.setText("Rest: 4-5 minutes");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BenchPress.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BenchPress().setVisible(true);
            }
        });
    }
